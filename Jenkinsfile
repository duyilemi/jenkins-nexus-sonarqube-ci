        ...
        stage("Deploy to Beanstalk-Staging Env") {
            steps {
                ...
                withAWS(credentials: 'awsbeans', region: 'us-east-1') {
                    ...
                    sh 'aws elasticbeanstalk create-application-version --application-name $AWS_EB_APP_NAME --version-label $AWS_EB_APP_VERSION --source-bundle S3Bucket=$AWS_S3_BUCKET, S3Key=$AWS_S3_BUCKET/$ARTIFACT_NAME'
